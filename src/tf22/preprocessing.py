...
def grayworld_2(image):
    """
    Apply  grayworld white balancing with faster implementation
...
def imagenet_rgb_subtract(image):    
    """
    Subtract the Imagenet average intensity values from each channel in a BGR image.
...
def preprocess_image(image):
    ...
    """
    result = grayworld_2(image) # use faster implementation
